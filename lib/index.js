...
function Strategy(options, verify) {
  ...
  this.options = xtend({}, options, {
    authorizationURL: 'https://' + options.host + '/auth/realms/' + options.realm + '/tokens/login',
    tokenURL:         'https://' + options.host + '/auth/realms/' + options.realm + '/tokens/access/codes',
    userInfoURL:      'https://' + options.host + '/auth/userinfo',
    apiUrl:           'https://' + options.host + '/auth/api'
  });
